...
The system SHALL render a TipTap editor for the note body. The editor SHALL support bold, italic, headings, bullet lists, and ordered lists at minimum. Content SHALL be stored internally as TipTap JSON.
